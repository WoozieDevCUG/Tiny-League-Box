...
template <> constexpr inline auto HttpClient::qt_create_metaobjectdata<qt_meta_tag_ZN10HttpClientE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'ratingSubmitted'
        QtMocHelpers::SignalData<void(int, int)>(28, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 14 }, { QMetaType::Int, 29 },
        }}),
        // Signal 'ratingSubmitFailed'
        QtMocHelpers::SignalData<void(const QString &)>(30, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 7 },
        }}),
        // Signal 'ratingSummaryFetched'
        QtMocHelpers::SignalData<void(int, double, int)>(31, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 14 }, { QMetaType::Double, 32 }, { QMetaType::Int, 33 },
        }}),
        // Signal 'ratingSummaryFailed'
        QtMocHelpers::SignalData<void(const QString &)>(34, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 7 },
        }}),
        // Signal 'ratingsFetched'
        QtMocHelpers::SignalData<void(int, const QList<UserRating> &)>(35, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 14 }, { 0x80000000 | 36, 37 },
        }}),
        // Signal 'ratingsFailed'
...
void HttpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 14: _t->ratingSubmitted((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        case 15: _t->ratingSubmitFailed((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 16: _t->ratingSummaryFetched((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<double>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[3]))); break;
        case 17: _t->ratingSummaryFailed((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 18: _t->ratingsFetched((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QList<UserRating>>>(_a[2]))); break;
        case 19: _t->ratingsFailed((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (HttpClient::*)(const QString & )>(_a, &HttpClient::userProfileFailed, 13))
            return;
        if (QtMocHelpers::indexOfMethod<void (HttpClient::*)(int , int )>(_a, &HttpClient::ratingSubmitted, 14))
            return;
        if (QtMocHelpers::indexOfMethod<void (HttpClient::*)(const QString & )>(_a, &HttpClient::ratingSubmitFailed, 15))
            return;
        if (QtMocHelpers::indexOfMethod<void (HttpClient::*)(int , double , int )>(_a, &HttpClient::ratingSummaryFetched, 16))
            return;
        if (QtMocHelpers::indexOfMethod<void (HttpClient::*)(const QString & )>(_a, &HttpClient::ratingSummaryFailed, 17))
            return;
        if (QtMocHelpers::indexOfMethod<void (HttpClient::*)(int , const QList<UserRating> & )>(_a, &HttpClient::ratingsFetched, 18))
            return;
        if (QtMocHelpers::indexOfMethod<void (HttpClient::*)(const QString & )>(_a, &HttpClient::ratingsFailed, 19))
            return;
    }
}
...
// SIGNAL 14
void HttpClient::ratingSubmitted(int _t1, int _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 14, nullptr, _t1, _t2);
}

// SIGNAL 15
void HttpClient::ratingSubmitFailed(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 15, nullptr, _t1);
}

// SIGNAL 16
void HttpClient::ratingSummaryFetched(int _t1, double _t2, int _t3)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 16, nullptr, _t1, _t2, _t3);
}

// SIGNAL 17
void HttpClient::ratingSummaryFailed(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 17, nullptr, _t1);
}

// SIGNAL 18
void HttpClient::ratingsFetched(int _t1, const QList<UserRating> & _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 18, nullptr, _t1, _t2);
}

// SIGNAL 19
void HttpClient::ratingsFailed(const QString & _t1)
{
