...
template <> constexpr inline auto Widget::qt_create_metaobjectdata<qt_meta_tag_ZN6WidgetE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "showHeroDetail",
        "heroId",
        "onHeroDetailBackRequested",
        "onRatingSubmitted",
        "stars",
        "onRatingSummaryFetched",
        "avg",
        "count",
        "onRatingsFetched",
        "QList<UserRating>",
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onHeroDetailBackRequested'
        QtMocHelpers::SlotData<void()>(26, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onRatingSubmitted'
        QtMocHelpers::SlotData<void(int, int)>(27, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Int, 25 }, { QMetaType::Int, 28 },
        }}),
        // Slot 'onRatingSummaryFetched'
        QtMocHelpers::SlotData<void(int, double, int)>(29, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Int, 25 }, { QMetaType::Double, 30 }, { QMetaType::Int, 31 },
        }}),
        // Slot 'onRatingsFetched'
        QtMocHelpers::SlotData<void(int, const QList<UserRating> &)>(32, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Int, 25 }, { 0x80000000 | 33, 34 },
        }}),
    };
...
void Widget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 16: _t->showHeroDetail((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 17: _t->onHeroDetailBackRequested(); break;
        case 18: _t->onRatingSubmitted((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        case 19: _t->onRatingSummaryFetched((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<double>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[3]))); break;
        case 20: _t->onRatingsFetched((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QList<UserRating>>>(_a[2]))); break;
        default: ;
        }
    }
}
