...
template <> constexpr inline auto HttpClient::qt_create_metaobjectdata<qt_meta_tag_ZN10HttpClientE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(int, const QPixmap &)>(13, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 14 }, { QMetaType::QPixmap, 15 },
        }}),
        ...
        QtMocHelpers::SignalData<void(const QString &, int, const QString &)>(19, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 4 }, { QMetaType::Int, 20 }, { QMetaType::QString, 5 },
        }}),
...
void HttpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->imageDownloaded((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QPixmap>>(_a[2]))); break;
        case 6: _t->requestFailed((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 7: _t->avatarUploadSucceeded((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 8: _t->avatarUploadFailed((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 9: _t->userProfileFetched((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[3]))); break;
        case 10: _t->userProfileFailed((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (HttpClient::*)(const QList<HeroBrief> & )>(_a, &HttpClient::heroesFetched, 4))
            return;
        if (QtMocHelpers::indexOfMethod<void (HttpClient::*)(int , const QPixmap & )>(_a, &HttpClient::imageDownloaded, 5))
            return;
        if (QtMocHelpers::indexOfMethod<void (HttpClient::*)(const QString & )>(_a, &HttpClient::requestFailed, 6))
            return;
        if (QtMocHelpers::indexOfMethod<void (HttpClient::*)(const QString & )>(_a, &HttpClient::avatarUploadSucceeded, 7))
            return;
        if (QtMocHelpers::indexOfMethod<void (HttpClient::*)(const QString & )>(_a, &HttpClient::avatarUploadFailed, 8))
            return;
        if (QtMocHelpers::indexOfMethod<void (HttpClient::*)(const QString & , int , const QString & )>(_a, &HttpClient::userProfileFetched, 9))
            return;
        if (QtMocHelpers::indexOfMethod<void (HttpClient::*)(const QString & )>(_a, &HttpClient::userProfileFailed, 10))
            return;
    }
}
